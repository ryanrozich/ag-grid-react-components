...
import { parseDateExpression, isValidDateExpression, resolveDateExpression } from './dateExpressionParser';
...
describe('dateExpressionParser', () => {
  ...
  describe('parseDateExpression', () => {
    ...
    it('should handle weeks', () => {
      ...
      expect(resultAdd.resolvedDate?.getTime()).toBe(addWeeks(today, 2).getTime());
      
      expect(resultSub.isValid).toBe(true);
      expect(resultSub.resolvedDate?.getTime()).toBe(subWeeks(today, 1).getTime());
    });
    ...
    it('should handle months', () => {
      ...
      expect(resultAdd.isValid).toBe(true);
      expect(resultAdd.resolvedDate?.getTime()).toBe(addMonths(today, 3).getTime());
      
      expect(resultSub.isValid).toBe(true);
      expect(resultSub.resolvedDate?.getTime()).toBe(subMonths(today, 6).getTime());
    });
    ...
    it('should handle years', () => {
      ...
      expect(resultAdd.isValid).toBe(true);
      expect(resultAdd.resolvedDate?.getTime()).toBe(addYears(today, 1).getTime());
      
      expect(resultSub.isValid).toBe(true);
      expect(resultSub.resolvedDate?.getTime()).toBe(subYears(today, 2).getTime());
    });
  ...
  describe('resolveDateExpression', () => {
    it('should return the correct date for valid expressions', () => {
      ...
      expect(resolveDateExpression('Today+5d')?.getTime()).toBe(addDays(today, 5).getTime());
      expect(resolveDateExpression('Today-2w')?.getTime()).toBe(subWeeks(today, 2).getTime());
    });
