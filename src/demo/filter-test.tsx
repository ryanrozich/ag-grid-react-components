...
const testData = [
  ...
  { id: 2, name: "Yesterday Item", date: new Date(Date.now() - 24 * 60 * 60 * 1000) },
  { id: 3, name: "Last Week Item", date: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000) },
  { id: 4, name: "Future Item", date: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000) },
];
...
export const FilterTest: React.FC = () => {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      <div style={{ height: "300px", marginBottom: "20px" }} className="ag-theme-quartz">
        <AgGridReact
          ref={gridRef}
          rowData={testData}
