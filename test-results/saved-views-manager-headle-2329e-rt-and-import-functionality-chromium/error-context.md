...
- Name: SavedViewsManager Headless Component E2E Tests >> Export and import functionality
- Location: /Users/ryan/code-repos/github/ryanrozich/ag-grid-react-components-worktrees/feat/v2-headless-components/tests/e2e/saved-views-manager-headless.spec.ts:250:3
...
Call log:
  ...
  - attempting click action
    ...
    at /Users/ryan/code-repos/github/ryanrozich/ag-grid-react-components-worktrees/feat/v2-headless-components/tests/e2e/saved-views-manager-headless.spec.ts:257:71
```
...
- text: View Name
- textbox "View Name": Export Test View
