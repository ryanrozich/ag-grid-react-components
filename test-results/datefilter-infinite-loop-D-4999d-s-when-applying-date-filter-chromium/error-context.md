...
- Name: DateFilter Infinite Loop Bug >> should monitor React re-renders when applying date filter
- Location: /Users/ryan/code-repos/github/ryanrozich/ag-grid-react-components-worktrees/feat/v2-headless-components/tests/e2e/datefilter-infinite-loop.spec.ts:59:3
...
Call log:
  - waiting for locator('.ag-theme-quartz') to be visible
    ...
    at /Users/ryan/code-repos/github/ryanrozich/ag-grid-react-components-worktrees/feat/v2-headless-components/tests/e2e/datefilter-infinite-loop.spec.ts:64:16
```
