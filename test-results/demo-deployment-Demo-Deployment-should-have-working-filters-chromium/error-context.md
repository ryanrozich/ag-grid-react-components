...
- Location: /Users/ryan/code-repos/github/ryanrozich/ag-grid-react-components-worktrees/feat/v2-headless-components/tests/e2e/demo-deployment.spec.ts:79:3
...
Call log:
  - waiting for locator('.ag-header-cell:has-text(\'Status\') .ag-header-cell-menu-button')
    ...
    at /Users/ryan/code-repos/github/ryanrozich/ag-grid-react-components-worktrees/feat/v2-headless-components/tests/e2e/demo-deployment.spec.ts:83:8
```
