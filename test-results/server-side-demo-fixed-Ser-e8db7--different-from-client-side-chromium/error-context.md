...
- Name: Server-Side Demo Fixed >> server-side data should be different from client-side
- Location: /Users/ryan/code-repos/github/ryanrozich/ag-grid-datefilter-fix/tests/e2e/server-side-demo-fixed.spec.ts:137:3
...
Expected value: "Task ID"
Received array: ["ID", "Task", "Status", "Priority", "Category", "Assignee", "Due Date", "% Delivered", "Value", "Task", …]
    at /Users/ryan/code-repos/github/ryanrozich/ag-grid-datefilter-fix/tests/e2e/server-side-demo-fixed.spec.ts:157:27
```
